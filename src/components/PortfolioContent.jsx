...
const PortfolioContent = () => {
  ...
  return (
    <div className="relative w-screen h-screen bg-white overflow-hidden">
      ...
      <div className="relative container mx-auto z-10 w-full h-full flex flex-col p-4">
        <div className=" w-full flex flex-col h-full items-center justify-center overflow-hidden md:p-5 p-4">
          <BubbleMenu
          ...
          <div className=" flex-grow rounded-2xl px-1 py-4 mt-[70px]  bg-white/30 backdrop-blur-sm w-full h-full lg:rounded-3xl lg:p-5 flex lg:flex-row flex-col items-center lg:items-start  justify-between gap-3 lg:overflow-auto overflow-y-scroll">
            ...
            <div className="w-full lg:max-h-[700px] lg:overflow-y-scroll h-full flex flex-col gap-5 lg:w-2/3">
